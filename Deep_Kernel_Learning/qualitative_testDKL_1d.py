...
parser.add_argument('--num-context', type=int, default=10, metavar='N',
                    help='dimension of latent variable in np')
parser.add_argument('--num-target', type=int, default=90, metavar='N',
                    help='dimension of latent variable in np')
parser.add_argument('--directory-path', default='/home/francesco/PycharmProjects/MasterThesis/plots/DKL/',
...
model = GPRegressionModel(x_init.squeeze(0), y_init.squeeze(0).squeeze(-1), likelihood,
...
plot_posterior(data_loader, model, 'Posterior', args, num_func=2)
