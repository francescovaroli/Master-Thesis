...
folder_path = '/media/francesco/Irene/Francesco/Master Thesis/scratch/trpo_mount_7b/'
...
ax_rew.plot(step_plot, mean, alpha=alpha, c=color, label='mean')
ax_rew.fill_between(step_plot, perc_20, perc_80, color=color, alpha=alpha/3)
